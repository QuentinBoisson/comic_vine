...
class AppColors {
  ...
  static const Color selectedBottomBarBackground = Color(0xFF12273C);
  static const Color bottomBarText = Color(0xFF12273C);
  static const Color selectedBottomBarText = Color(0xFF778BA8);
}
